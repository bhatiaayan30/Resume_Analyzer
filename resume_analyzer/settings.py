...
if DEBUG:
    ...
    # Use SMTP or external API (e.g., SendGrid, AWS SES) in production.
    # Currently configured to fallback to console if not properly setup, but
    # ideally you configure EMAIL_HOST, EMAIL_PORT, etc. here.
